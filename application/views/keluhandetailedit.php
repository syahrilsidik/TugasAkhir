...
<div id="heads">
    <div class="critical">
        <h2>View Item Request</h2>
            ...
            <form name="edititemrequest" method="POST" action="<?php echo site_url('keluhan/edit_keluhan') ?>" onsubmit="return validateForm()">
                <input type="hidden" value="<?php echo $_GET['id'];?>" name="id" />
                <tr>
                    <td style="width: 20%;">ID Keluhan</td>
                    <td class="td-content"><?php echo $keluhan[0]['id_keluhan'] ?></td>
                    ...
                    <td class="td-content">
                        ...
                        $isi = array(
                                    ...
                                    'Selesai'=>'Selesai');
                        echo form_dropdown('selPrior',$isi,$keluhan[0]['pengerjaan'],'id="Prior" style="width:100%;"');
                ...
                <tr>
                    <td>Nama Pelapor</td>
                    <td class="td-content"><?php echo $keluhan[0]['id_pegawai'] ?></td>
                    
                    <td>Lab</td>
                    <td class="td-content">
                        <?php 
                           echo $keluhan[0]['nama_lab'] 
                         ?>
            ...
            <input type="submit" id="btnSubmit" name="btnSSubmit" class="buttonsubmit" value="Edit" />
            </div>
